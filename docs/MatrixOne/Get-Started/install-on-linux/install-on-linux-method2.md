...
=== "**下载方式三：页面下载**"
     ...
     如果你想通过更直观的页面下载的方式下载，直接点击进入[版本 1.0.1](https://github.com/matrixorigin/matrixone/releases/tag/v1.0.1)，下拉找到 **Assets** 栏，点击安装包 *mo-v1.0.1-linux-x86_64.zip* 或者 *mo-v1.0.1-linux-arm64.zip* 下载再使用 ```unzip``` 命令解压即可。
