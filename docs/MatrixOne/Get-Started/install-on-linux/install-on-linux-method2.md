...
=== "**下载方式一：`wget` 工具下载安装二进制包**"
     ...
     unzip mo-v1.2.2-linux-arm64.zip
     ```

    如 github 原地址下载过慢，您可尝试从以下地址下载镜像包：

    ```
    wget https://githubfast.com/matrixorigin/matrixone/releases/download/v1.2.2/mo-v1.2.2-linux-xxx.zip
    ```
...
=== "**下载方式二：`curl` 工具下载二进制包**"
    ...
    ```
    curl -OL https://githubfast.com/matrixorigin/matrixone/releases/download/v1.2.2/mo-v1.2.2-linux-xxx.zip
    ```
