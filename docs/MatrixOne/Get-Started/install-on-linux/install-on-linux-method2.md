...
=== "**下载方式一：`wget` 工具下载安装二进制包**"
     ...
     unzip mo-v1.2.0-linux-x86_64.zip
     ```
     ...
     unzip mo-v1.2.0-linux-arm64.zip
     ```

    如 github 原地址下载过慢，您可尝试从以下地址下载镜像包：

    ```
    wget https://githubfast.com/matrixorigin/matrixone/releases/download/v1.2.0/mo-v1.2.0-linux-xxx.zip
    ```
...
=== "**下载方式二：`curl` 工具下载二进制包**"
    ...
    ```
    curl -OL https://githubfast.com/matrixorigin/matrixone/releases/download/v1.2.0/mo-v1.2.0-linux-xxx.zip
    ```

=== "**下载方式三：页面下载**"

     如果你想通过更直观的页面下载的方式下载，直接点击进入[版本 1.2.0](https://github.com/matrixorigin/matrixone/releases/tag/v1.2.0)，下拉找到 **Assets** 栏，点击安装包 *mo-v1.2.0-linux-x86_64.zip* 或者 *mo-v1.2.0-linux-arm64.zip* 下载再使用 ```unzip``` 命令解压即可。
...
=== "**下载方式一：`wget` 工具下载安装二进制包**"
     ...
     ```bash
     wget https://github.com/matrixorigin/matrixone/releases/download/v1.2.0/mo-v1.2.0-musl-x86_64.zip
     unzip mo-v1.2.0-musl-x86_64.zip
     ```

     ARM 架构系统安装包：

     ```bash
     wget https://github.com/matrixorigin/matrixone/releases/download/v1.2.0/mo-v1.2.0-musl-arm64.zip
     unzip mo-v1.2.0-musl-arm64.zip
     ```

    如 github 原地址下载过慢，您可尝试从以下地址下载镜像包：

    ```
    wget https://githubfast.com/matrixorigin/matrixone/releases/download/v1.2.0/mo-v1.2.0-musl-xxx.zip
    ```
=== "**下载方式二：`curl` 工具下载二进制包**"
     ...
     ```bash
     curl -OL https://github.com/matrixorigin/matrixone/releases/download/v1.2.0/mo-v1.2.0-musl-x86_64.zip
     unzip mo-v1.2.0-musl-x86_64.zip
     ```
     ...
     ```bash
     curl -OL https://github.com/matrixorigin/matrixone/releases/download/v1.2.0/mo-v1.2.0-musl-arm64.zip
     unzip mo-v1.2.0-musl-arm64.zip
     ```
    ...
    ```
    curl -OL https://githubfast.com/matrixorigin/matrixone/releases/download/v1.2.0/mo-v1.2.0-musl-xxx.zip
    ```

=== "**下载方式三：页面下载**"

     如果你想通过更直观的页面下载的方式下载，直接点击进入[版本 1.2.0](https://github.com/matrixorigin/matrixone/releases/tag/v1.2.0)，下拉找到 **Assets** 栏，点击安装包 *mo-v1.2.0-musl-x86_64.zip* 或者 *mo-v1.2.0-musl-arm64.zip* 下载再使用 ```unzip``` 命令解压即可。
...
```
mo_ctl set_conf MO_PATH="/yourpath/mo-v1.2.0-xx-xx" #设置MatrixOne路径为二进制解压文件目录
mo_ctl set_conf MO_CONF_FILE="/yourpath/mo-v1.2.0-xx-xx/etc/launch/launch.toml" #设置MatrixOne配置文件路径
...
如果运行正常将出现以下日志。MatrixOne 的相关运行日志会在 `/yourpath/mo-v1.2.0-xx-xx/matrixone/logs/` 中。
