...
=== "**下载方式一：`wget` 工具下载安装二进制包**"
    ...
    ```
    wget https://githubfast.com/matrixorigin/matrixone/releases/download/v1.1.0/mo-v1.1.0-linux-xxx.zip
    ```
=== "**下载方式二：`curl` 工具下载二进制包**"
    ...
    ``` 
    curl -OL https://githubfast.com/matrixorigin/matrixone/releases/download/v1.1.0/mo-v1.1.0-linux-xxx.zip
    ```
