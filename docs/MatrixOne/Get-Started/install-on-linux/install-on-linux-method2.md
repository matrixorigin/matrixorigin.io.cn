...
=== "**下载方式一：`wget` 工具下载安装二进制包**"
     ...
     ```bash
     wget https://github.com/matrixorigin/matrixone/releases/download/v3.0.6/mo-v3.0.6-musl-x86_64.zip
     unzip mo-v3.0.6-musl-x86_64.zip
     ```

     ARM 架构系统安装包：

     ```bash
     wget https://github.com/matrixorigin/matrixone/releases/download/v3.0.6/mo-v3.0.6-musl-arm64.zip
     unzip mo-v3.0.6-musl-arm64.zip
     ```

    如 github 原地址下载过慢，您可尝试从以下地址下载镜像包：

    ```
    wget https://githubfast.com/matrixorigin/matrixone/releases/download/v3.0.6/mo-v3.0.6-musl-xxx.zip
    ```
=== "**下载方式二：`curl` 工具下载二进制包**"
     ...
     ```bash
     curl -OL https://github.com/matrixorigin/matrixone/releases/download/v3.0.6/mo-v3.0.6-musl-x86_64.zip
     unzip mo-v3.0.6-musl-x86_64.zip
     ```
     ...
     ```bash
     curl -OL https://github.com/matrixorigin/matrixone/releases/download/v3.0.6/mo-v3.0.6-musl-arm64.zip
     unzip mo-v3.0.6-musl-arm64.zip
     ```
    ...
    ```
    curl -OL https://githubfast.com/matrixorigin/matrixone/releases/download/v3.0.6/mo-v3.0.6-musl-xxx.zip
    ```

=== "**下载方式三：页面下载**"

     如果你想通过更直观的页面下载的方式下载，直接点击进入[版本 3.0.6](https://github.com/matrixorigin/matrixone/releases/tag/v3.0.6)，下拉找到 **Assets** 栏，点击安装包 *mo-v3.0.6-musl-x86_64.zip* 或者 *mo-v3.0.6-musl-arm64.zip* 下载再使用 ```unzip``` 命令解压即可。
...
=== "**下载方式一：`wget` 工具下载安装二进制包**"
     ...
     unzip mo-v3.0.6-linux-x86_64.zip
     ```
     ...
     unzip mo-v3.0.6-linux-arm64.zip
     ```

    如 github 原地址下载过慢，您可尝试从以下地址下载镜像包：

    ```
    wget https://githubfast.com/matrixorigin/matrixone/releases/download/v3.0.6/mo-v3.0.6-linux-xxx.zip
    ```
...
=== "**下载方式二：`curl` 工具下载二进制包**"
    ...
    ```
    curl -OL https://githubfast.com/matrixorigin/matrixone/releases/download/v3.0.6/mo-v3.0.6-linux-xxx.zip
    ```

=== "**下载方式三：页面下载**"

     如果你想通过更直观的页面下载的方式下载，直接点击进入[版本 3.0.6](https://github.com/matrixorigin/matrixone/releases/tag/v3.0.6)，下拉找到 **Assets** 栏，点击安装包 *mo-v3.0.6-linux-x86_64.zip* 或者 *mo-v3.0.6-linux-arm64.zip* 下载再使用 ```unzip``` 命令解压即可。
