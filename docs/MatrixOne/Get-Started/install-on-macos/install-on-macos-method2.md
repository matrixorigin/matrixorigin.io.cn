...
=== "**下载方式一：`wget` 工具下载安装二进制包**"
     ...
     unzip mo-v3.0.3-darwin-x86_64.zip
     ```
     ...
     unzip mo-v3.0.3-darwin-arm64.zip
     ```

    如 github 原地址下载过慢，您可尝试从以下地址下载镜像包：

    ```
    wget https://githubfast.com/matrixorigin/matrixone/releases/download/v3.0.3/mo-v3.0.3-darwin-xxx.zip
    ```
...
=== "**下载方式二：`curl` 工具下载二进制包**"
    ...
    ```
    curl -OL https://githubfast.com/matrixorigin/matrixone/releases/download/v3.0.3/mo-v3.0.3-darwin-xxx.zip
    ```

=== "**下载方式三：页面下载**"

     如果你想通过更直观的页面下载的方式下载，直接点击进入[版本 3.0.3](https://github.com/matrixorigin/matrixone/releases/tag/v3.0.3)，下拉找到 **Assets** 栏，点击安装包 *mo-v3.0.3-darwin-x86_64.zip* 或 *mo-v3.0.3-darwin-arm64.zip* 下载即可。
