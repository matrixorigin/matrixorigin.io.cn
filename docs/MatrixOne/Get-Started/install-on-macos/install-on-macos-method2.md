...
=== "**下载方式一：`wget` 工具下载安装二进制包**"
     ...
     ```bash
     wget https://github.com/matrixorigin/matrixone/releases/download/v3.0.10/mo-v3.0.10-darwin-x86_64.zip
     unzip mo-v3.0.10-darwin-x86_64.zip
     ```

     ARM 架构系统安装包：

     ```bash
     wget https://github.com/matrixorigin/matrixone/releases/download/v3.0.10/mo-v3.0.10-darwin-arm64.zip
     unzip mo-v3.0.10-darwin-arm64.zip
     ```

    如 github 原地址下载过慢，您可尝试从以下地址下载镜像包：

    ```
    wget https://githubfast.com/matrixorigin/matrixone/releases/download/v3.0.10/mo-v3.0.10-darwin-xxx.zip
    ```
...
=== "**下载方式二：`curl` 工具下载二进制包**"
     ...
     ```bash
     curl -OL https://github.com/matrixorigin/matrixone/releases/download/v3.0.10/mo-v3.0.10-darwin-x86_64.zip
     unzip mo-v3.0.10-darwin-x86_64.zip
     ```
     ...
     ```bash
     curl -OL https://github.com/matrixorigin/matrixone/releases/download/v3.0.10/mo-v3.0.10-darwin-arm64.zip
     unzip mo-v3.0.10-darwin-arm64.zip
     ```
    ...
    ```
    curl -OL https://githubfast.com/matrixorigin/matrixone/releases/download/v3.0.10/mo-v3.0.10-darwin-xxx.zip
    ```

=== "**下载方式三：页面下载**"

     如果你想通过更直观的页面下载的方式下载，直接点击进入[版本 3.0.10](https://github.com/matrixorigin/matrixone/releases/tag/v3.0.10)，下拉找到 **Assets** 栏，点击安装包 *mo-v3.0.10-darwin-x86_64.zip* 或 *mo-v3.0.10-darwin-arm64.zip* 下载即可。
...
2024-03-07 14:34:05.072 UTC+0800    [INFO]    Starting mo-service: cd /Users/admin/mo-v3.0.10-darwin-arm64/ && GOMEMLIMIT=14745MiB /Users/admin/mo-v3.0.10-darwin-arm64/mo-service -daemon -debug-http :9876 -launch /Users/admin/mo-v3.0.10-darwin-arm64/etc/launch/launch.toml >/Users/admin/mo-v3.0.10-darwin-arm64/matrixone/logs/stdout-20240307_143405.log 2>/Users/admin/mo-v3.0.10-darwin-arm64/matrixone/logs/stderr-20240307_143405.log
...
2024-03-07 14:34:07.261 UTC+0800    [INFO]    At least one mo-service is running. Process info: 
  501 27145     1   0  2:34下午 ??         0:00.18 /Users/admin/mo-v3.0.10-darwin-arm64/mo-service -daemon -debug-http :9876 -launch /Users/admin/mo-v3.0.10-darwin-arm64/etc/launch/launch.toml
