...
To build MatrixOne locally, golang 1.22 is required. You can follow these steps to make sure your golang whether is ready.

```
$ go version
```

If the result is like `'go version go1.22 xxxxxx'`, you can skip step 2 and build your MatrixOne. If lower than go 1.22 or no golang, your can follow step 2 to configure your own golang 1.22 environment locally.
