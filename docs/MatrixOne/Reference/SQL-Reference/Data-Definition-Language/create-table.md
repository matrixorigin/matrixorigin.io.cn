...
-- 指定分区算法
CREATE TABLE tp3 (col1 INT, col2 CHAR(5), col3 DATE) PARTITION BY KEY ALGORITHM = 1 (col3);
...
-- 多列分区
CREATE TABLE tp5 ( col1 INT, col2 CHAR(5), col3 DATE) PARTITION BY KEY(col1, col2) PARTITIONS 4;
