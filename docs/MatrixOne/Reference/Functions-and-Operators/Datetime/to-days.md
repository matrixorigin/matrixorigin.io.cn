...
llms_summary: TO_DAYS() 用于计算给定日期与公历日历的开始日期（0000 年 1 月 1 日）之间的天数差。如果 date 是 NULL，则返回 NULL。
---

# **TO_DAYS()**


> TO_DAYS() 用于计算给定日期与公历日历的开始日期（0000 年 1 月 1 日）之间的天数差。如果 date 是 NULL，则返回
> NULL。
