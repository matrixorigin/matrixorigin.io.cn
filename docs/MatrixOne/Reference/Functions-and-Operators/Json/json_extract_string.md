...
```sql
select col_name from tab_name where json_extract_string(jsonDoc, pathExpression)= str;
```
...
```sql
create table student(n1 json);
insert into student values
    ('{"name": "tom", "age": 18, "score": 90,"gender": "male"}'),
    ('{"name": "bob", "age": 20, "score": 80,"gender": "male"}'),
    ('{"name": "jane", "age": 17, "score": 95,"gender": "female"}'),
    ('{"name": "lily", "age": 19, "score": 79,"gender": "female"}');

mysql>  select n1 from student where  json_extract_string(n1,'$.name')='tom';
+-----------------------------------------------------------+
| n1                                                        |
+-----------------------------------------------------------+
| {"age": 18, "gender": "male", "name": "tom", "score": 90} |
+-----------------------------------------------------------+
