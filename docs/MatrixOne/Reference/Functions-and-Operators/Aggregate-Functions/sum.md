...
llms_summary: SUM() 聚合函数用于计算一组值的和（NULL 值被忽略），自 v3.0.14 起支持布尔表达式。
---

# **SUM**

> SUM() 聚合函数用于计算一组值的和（NULL 值被忽略）。支持布尔表达式，TRUE 视为 1、FALSE 视为 0。
...
|  参数  | 说明 |
|  ----  | ----  |
| expr  | 任何数值类型与字符串列的列名，也支持布尔表达式（TRUE 视为 1、FALSE 视为 0）|
