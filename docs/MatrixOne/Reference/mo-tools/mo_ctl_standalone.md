...
Usage         : mo_ctl deploy [mo_version] [force] # deploy mo onto the path configured
  ...
  e.g.        : mo_ctl deploy             # default, same as mo_ctl deploy 3.0.10
              : mo_ctl deploy main        # deploy development latest version
              : mo_ctl deploy d29764a     # deploy development version d29764a
              : mo_ctl deploy 3.0.10       # deploy stable verson 3.0.10
              : mo_ctl deploy force       # delete all under MO_PATH and deploy verson 3.0.10
              : mo_ctl deploy 3.0.10 force # delete all under MO_PATH and deploy stable verson 3.0.10 from beginning
```
...
| MO_DEFAULT_VERSION     | 默认拉取的 MatrixOne 的版本                            | 默认为 3.0.10                                      |
...
Usage           : mo_ctl upgrade [version_commitid]   # upgrade or downgrade mo from current version to a target commit id or stable version
 [commitid]     : a commit id such as '38888f7', or a stable version such as '3.0.10'
  ...
  e.g.          : mo_ctl upgrade 38888f7              # upgrade/downgrade to commit id 38888f7 on main branch
                ...
                : mo_ctl upgrade 3.0.10               # upgrade/downgrade to stable version 3.0.10
```
