...
Usage         : mo_ctl deploy [mo_version] [force] # deploy mo onto the path configured
  ...
  e.g.        : mo_ctl deploy             # default, same as mo_ctl deploy 3.0.13
              ...
              : mo_ctl deploy 3.0.13       # deploy stable verson 3.0.13
              : mo_ctl deploy force       # delete all under MO_PATH and deploy verson 3.0.13
              : mo_ctl deploy 3.0.13 force # delete all under MO_PATH and deploy stable verson 3.0.13 from beginning
```
...
| MO_DEFAULT_VERSION     | 默认拉取的 MatrixOne 的版本                            | 默认为 3.0.13                                      |
