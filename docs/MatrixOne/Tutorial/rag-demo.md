...
"The lastest version of MatrixOne is 1.2.1, releases on 27th June, 2024.",
...
```
Based on the provided data, the latest version of MatrixOne is 1.2.1, which was released on June 27th, 2024.
```
