...
"The lastest version of MatrixOne is 2.0.3, releases on 2025/03/12.",
...
```
Based on the provided data, the latest version of MatrixOne is 2.0.3, which was released on 2025/03/12.
```
