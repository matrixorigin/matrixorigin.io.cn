...
"The lastest version of MatrixOne is 1.2.3, releases on 11th Sep, 2024.",
...
```
Based on the provided data, the latest version of MatrixOne is 1.2.3, which was released on Sep 11th, 2024.
```
