...
"The lastest version of MatrixOne is 3.0.2, releases on 2025/10/11.",
...
```
Based on the provided data, the latest version of MatrixOne is 3.0.2, which was released on 2025/08/26.
```
