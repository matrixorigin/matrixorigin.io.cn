...
"The lastest version of MatrixOne is 3.0.1, releases on 2025/09/26.",
...
```
Based on the provided data, the latest version of MatrixOne is 3.0.1, which was released on 2025/08/26.
```
